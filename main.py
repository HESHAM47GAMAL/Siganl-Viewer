    ...
    def GenPdf(self):
        ...
        if (self.pdf_check[0]):
            ...
            self.picture_for_signal_1.save(
                r'E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\signal_channel_1.png')
            self.image_signal_channel_1 = "E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\signal_channel_1.png"
            ...
            self.picture_for_spec_1.save(
                r'E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\spec_channel_1.png')
            self.image_spec_channel_1 = "E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\spec_channel_1.png"
            ...
            self.place_second_line_Datastatistics = Table(self.data_second_line_Datastatistics, 1 * [2.4 * inch], 1 * [.7 * inch])
        ...
        if (self.pdf_check[1]):
            ...
            self.picture_for_signal_2.save(
                r'E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\signal_channel_2.png')
            self.image_signal_channel_2 = "E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\signal_channel_2.png"
            ...
            self.sequnce_of_display_data.append(self.place_second_line_spec)
            self.ui.tabWidget_2.setCurrentIndex(1)
            self.picture_for_spec_2 = screen.grabWindow(self.Canvas[0].winId())
            self.picture_for_spec_2.save(
                r'E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\spec_channel_2.png')
            self.image_spec_channel_2 = "E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\spec_channel_2.png"
        ...
        if (self.pdf_check[2]):
            ...
            self.picture_for_signal_3.save(
                r'E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\signal_channel_3.png')
            self.image_signal_channel_3 = "E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\signal_channel_3.png"
            ...
            self.picture_for_spec_3.save(
                r'E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\spec_channel_3.png')
            self.image_spec_channel_3 = "E:\THIRD YEAR FIRST TERM\Biological Signal Processing_SBE3110  DSP\TASKS\Task_1\Pre Pre Pre Pre Pre  Final fuck this name _that we submit\spec_channel_3.png"
